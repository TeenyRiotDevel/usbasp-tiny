...
PROGRAMMER = -c USBasp
#PROGRAMMER = -c stk500hvsp -P avrdoper
...
#FUSEOPT_t85 = -U lfuse:w:0xa1:m -U hfuse:w:0xdd:m -U efuse:w:0xfe:m		#enable clock output on pb4
FUSEOPT_t85_DISABLERESET = -U lfuse:w:0xe1:m -U efuse:w:0xfe:m -U hfuse:w:0x5d:m
FUSEOPT = $(FUSEOPT_t85_DISABLERESET)
...
ARDUINOAPPDIR = /Applications/Development/Arduino1.0.5_trinket.app
AVRDIR		= $(ARDUINOAPPDIR)/Contents/Resources/Java/hardware/tools/avr
AVRBIN		= $(AVRDIR)/bin
...
clean:
	rm -f main.hex main.bin *.o usbdrv/*.o main.s usbdrv/oddebug.s usbdrv/usbdrv.s libs-device/osccal.o main.c.lst main.map
